...
for i = 1:length(subject_list)
    file_name = sprintf('%s/%s_ct.nii.gz',input_folder,subject_list);
    file_mr =  sprintf('%s/%s_r1.nii.gz',input_folder,subject_list);
    file_mk = sprintf('%s/%s_mk.nii.gz',input_folder,subject_list);
