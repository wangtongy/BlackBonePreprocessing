...
get_levelset_mask(Center_folder,SB_049,'nonorm_ct');
keep_only_largest_region(Center_folder,Center_folder,SB_049,'ct');
...
dcm2nii(Dcm_mr_Folder,resize_subject,1);
%% Bias field correction
Bias_field_correction(Dcm_mr_Folder,Center_folder,resize_subject);
